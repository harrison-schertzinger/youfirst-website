...
export const metadata: Metadata = {
  ...
  description:
    "YOU. FIRST development teams, classes 2032 & 2033 — 2034s who are ready play up. The most development-focused club in the area. Free evaluations any morning through August 7 at the Cincinnati Lacrosse Academy.",
};
